...
async def favicon():
    ...
    the AVIF logo so we don't pollute logs with 404s; modern browsers accept
    AVIF served at the .ico path."""
    return FileResponse(str(STATIC_DIR / 'favicon.avif'), media_type='image/avif')
